...
VERSION = "1.0"
HOME = os.getenv("HOME")
COMMANDS = ["add_repo", "download", "exit", "help", "install_from_repo", "install_local", "remove", "remove_repo",  "show_available", "show_info", "show_installed", "show_repos", "update_list"]
